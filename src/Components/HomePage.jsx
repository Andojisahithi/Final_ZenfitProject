...
const HomePage = () => {
  ...
  function calculateBMI() {
    ...
    document.getElementById(
      "bmiResult"
    ).innerHTML = `Your BMI is ${bmi} (${bmiCategory}).`;
  }
    ...
    <div>
      <div className="Header">
        ...
        <ul>
          ...
          <li>
            <HashLink className="homeheaderlink" smooth to="#BMI">
              BMI CALCULATOR
            </HashLink>
          </li>
          <li>PLANS</li>
      ...
      <div className="bmi-container" id="BMI">
        <div className="section_div_2">
          ...
          >
            ...
            <p id="bmiResult"></p>
            <button type="submit" class="bmi_calculate_btn">
              Calculate BMI
            </button>
          </form>
          ...
          <div className="para">
            <h2>WHAT IS BMI?</h2>
            <p>
              Body Mass Index (BMI) is a measure that uses your weight and
              height to estimate whether your body weight is healthy. It is a
              widely used tool to categorize individuals into different weight
            ...
            <p>
              ...
              <b>Disclaimer:</b> BMI is a general indicator and does not account
              for muscle mass, bone density, or other health factors. This
        ...
        <div class="item">
          ...
          <div class="text-content">
            <div className="text-content">
              ...
              <p>
                {" "}
                We’ve created a comfortable, safe and <br /> energetic
                environment for everyone. <br />
                A space where you can go at your own pace, <br /> and do your
                own thing without ever having <br />
                to worry about being judged.
              </p>
              <button class="simple-button" onClick={handleOpenLogin}>
                Learn More
              </button>
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="text-content">
              ...
              <p>
                Start 2025 off strong! Complete the Strong Start Challenge by{" "}
                <br />
                logging 200 minutes of any activity in the Strava app during{" "}
                <br />
                the month of January. When you finish, you'll get the exclusive{" "}
                <br /> Strong Start Challenge digital badge to show off on{" "}
                <br />
                your Strava profile..
              </p>
              <button class="simple-button" onClick={handleOpenLogin}>
          ...
          <div class="item">
            ...
            <div class="text-content">
              <h1>
                NEW! Workout Guides <br />
                As Per Your Goals
              </h1>
              <p>
                We believe in providing a high-quality experience as per <br />
                the requirement.Our Dietplans and Workout are Flexible.
              </p>
              <button class="simple-button" onClick={handleOpenLogin}>
                Explore More
              </button>
      ...
      <div class="last">
        <div class="horizontal-scroll-container" id="Services">
          <div class="item">
            <img src={diett} alt="Logo" />

            <div class="text-content">
              <div className="text-content">
                <h1>CUSTOMISED DIET </h1>
                <p>
                  We generate personalized diet plans as per the your health
                  goals <br />
                  and preferences. Whether it's for weight loss, muscle gain,{" "}
                  <br />
                  or a balanced diet, we've got you covered.
                </p>
            ...
            <div class="item">
              ...
              <div class="text-content">
                <h1>
                  CUSTOMISED WORKOUT <br />
                  PLAN
                </h1>
                <p>
                  Our custom workout plans are tailored to your fitness goals,
                  ensuring <br />
                  you achieve the results you're looking for. Whether you're a{" "}
                  <br />
                  beginner or an experienced athlete, we have the right <br />{" "}
                  plan for you.
                </p>
            ...
            <div class="item">
              ...
              <div class="text-content">
                <h1>
                  ZENFIT IS JUDGEMENTAL-
                  <br />
                  FREE ZONE
                </h1>
                <p>
                  At Zenfit, we believe in creating a supportive and
                  non-judgmental
                  <br />
                  environment where everyone can work towards their fitness
                  goals <br />
      ...
      <div className="lastsec">
        <div className="feature-list">
          ...
          <ul>
            ...
            <li>
              Options like yoga, Pilates, spin, Zumba,strength training...
            </li>
            <li>
              Social media integration for easy sharing of events and
              promotions.
            </li>
            <li>
              Performance analytics for tracking class popularity and membership
              trends.
            </li>
          </ul>
        </div>
        ...
        <div className="last">
          <p>
            ...
            parental/guardian consent. For detailed information, please visit
            our website. We reserve the right to modify services, terms, or
            availability at any time. ©2025 Zenfit Franchising LLC.
          </p>
        </div>
      </div>
